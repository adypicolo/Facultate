...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Pretul final pentru " + " mercedes1 " + "este " + dealership.getFinalPrice(mercedes1) + " euro.");
        System.out.println("Pretul final pentru " + " mercedes2 " + "este " + dealership.getFinalPrice(mercedes2) + " euro.");
        System.out.println("Pretul final pentru " + " fiat1 " + "este " + dealership.getFinalPrice(fiat1) + " euro.");
        System.out.println("Pretul final pentru " + " fiat2 " + "este " + dealership.getFinalPrice(fiat2) + " euro.");
        System.out.println("Pretul final pentru " + " skoda1 " + "este " + dealership.getFinalPrice(skoda1) + " euro.");
        System.out.println("Pretul final pentru " + " skoda2 " + "este " + dealership.getFinalPrice(skoda2) + " euro.");


        System.out.println("Incepem negocierea pentru: " + "mercedes3");
        //dealership.negotiate(mercedes3, 5.0);  // Aplica un discount de 5%
        ...
        System.out.println("\nPrețul final după aplicarea ofertelor:");
        for (Car car : cars) {
